...
function App() {
  ...
  const getAllUsers = () => {
    axios
      .get('https://db-crud-users.onrender.com/users')
  ...
  const addUsers = (newUsers) => {
       axios
      .post("https://db-crud-users.onrender.com/users", newUsers)
      .then(() => {
        getAllUsers();
  ...
  const deleteUsers = (users) => {
    ...
    axios
      .delete(`https://db-crud-users.onrender.com/users/${users.id}`)
      .then(() => {
        getAllUsers()
  ...
  const editUsers = (users) => {
    ...
    axios
      .put(
        `https://db-crud-users.onrender.com/users/${users.id}`,
        users
      )
      .then(() => {
        getAllUsers();
